...
def gradio_ask(user_message, chatbot, chat_state):
    ...
    #
    return (
        gr.update(interactive=False, placeholder="Currently only single round conversations are supported."),
        chatbot,
        chat_state,
    )
...
with gr.Blocks() as demo:
    ...
    upload_button.click(
        upload_speech, [speech, text_input, chat_state], [speech, text_input, upload_button, chat_state]
    )
