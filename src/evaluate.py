...
def get_dataset(dataset_cfg, run_cfg, task):
    testset = SALMONNTestDataset(dataset_cfg.prefix, dataset_cfg.test_ann_path, dataset_cfg.whisper_path, task)
...
def main(args):
    ...
    with open("/data/pgt/level4-nlp-finalproject-hackathon-nlp-07-lv3/src/prompts/test_prompt.json", "r") as f:
